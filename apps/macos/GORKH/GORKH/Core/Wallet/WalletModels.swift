...
struct AuditEvent: Codable, Equatable, Identifiable {
    enum Kind: String, Codable, CaseIterable {
        ...
        case cloakDepositApproved = "cloak_deposit_approved"
        case cloakDepositConfirmed = "cloak_deposit_confirmed"
        case cloakWithdrawApproved = "cloak_withdraw_approved"
        case cloakWithdrawConfirmed = "cloak_withdraw_confirmed"
        case cloakSigningRequestBlocked = "cloak_signing_request_blocked"
        case cloakPrivateStateStored = "cloak_private_state_stored"
        case cloakRPCConfigChecked = "cloak_rpc_config_checked"
        case cloakScanRequested = "cloak_scan_requested"
        case cloakScanSucceeded = "cloak_scan_succeeded"
        case cloakScanFailed = "cloak_scan_failed"
        case cloakScanCacheCleared = "cloak_scan_cache_cleared"
        case cloakActivityReconciled = "cloak_activity_reconciled"
        case cloakComplianceSummaryGenerated = "cloak_compliance_summary_generated"
        ...
        case orcaHarvestPlanCreated = "orca_harvest_plan_created"
        case orcaHarvestSimulationPassed = "orca_harvest_simulation_passed"
        case orcaHarvestSimulationFailed = "orca_harvest_simulation_failed"
        case orcaHarvestApproved = "orca_harvest_approved"
        case orcaHarvestSent = "orca_harvest_sent"
        case orcaHarvestFailed = "orca_harvest_failed"
        case orcaHarvestBlockedByGuard = "orca_harvest_blocked_by_guard"
        ...
        case yieldComparisonRefreshed = "yield_comparison_refreshed"
        case yieldSourceUnavailable = "yield_source_unavailable"
        case yieldSnapshotStored = "yield_snapshot_stored"
        case yieldPanelViewed = "yield_panel_viewed"
        case pnlPanelViewed = "pnl_panel_viewed"
        case pnlRefreshed = "pnl_refreshed"
        case costBasisEntryAdded = "cost_basis_entry_added"
        case costBasisEntryUpdated = "cost_basis_entry_updated"
        case costBasisEntryRemoved = "cost_basis_entry_removed"
        case pnlSnapshotGenerated = "pnl_snapshot_generated"
