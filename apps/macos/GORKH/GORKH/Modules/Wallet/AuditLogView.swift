    ...
    func includes(_ event: AuditEvent) -> Bool {
        ...
        case .portfolio:
            return [
                ...
                .pusdCirculationRefreshed,
                .pusdCirculationUnavailable,
                .yieldComparisonRefreshed,
                .yieldSourceUnavailable,
                .yieldSnapshotStored,
                .yieldPanelViewed,
                .pnlPanelViewed,
                .pnlRefreshed,
                .costBasisEntryAdded,
                .costBasisEntryUpdated,
                .costBasisEntryRemoved,
                .pnlSnapshotGenerated
            ].contains(event.kind)
        case .security:
            return [
                .walletAutoLocked,
...
private extension AuditEvent {
    var summaryDetails: String {
        let keys = [
            ...
            "pusdChainCount",
            "yieldHeldOpportunityCount",
            "yieldAPYAvailableCount",
            "yieldUnavailableCount",
            "yieldTopSource",
            "pnlStatus",
            "pnlTimeframe",
            "pnlHistoryPointCount",
            "pnlAssetPerformanceCount",
            "pnlWalletPerformanceCount",
            "realizedStatus",
            "unrealizedStatus",
            "costBasisEntryCount",
            "costBasisMissingAssetCount",
            "costBasisMethod",
            "swapActivityHintCount",
